const categories = [
    { label: 'Top', path: 'top', apiPath: 'Top250Movies' },
    { label: 'Most Popular', path: 'most_popular', apiPath: 'MostPopularMovies' },
    { label: 'In Theaters', path: 'in_theaters', apiPath: 'InTheaters' },
